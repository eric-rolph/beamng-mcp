    ...
    with ExitStack() as safety:
        ...
        try:
            async with create_connected_server_and_client_session(
                ...
                assert topology["node_count"] == CAGE_NODE_COUNT + CLOTH_NODE_COUNT + 7
                assert topology["fixed_node_count"] == CAGE_NODE_COUNT + 75
                ...
                assert topology["total_mass_kg"] == pytest.approx(17161.0, rel=1e-5)
