...
local RUNTIME_EXTENSION_NAME = "ericrolph__cannon__car__wash__lowvram_runtime"
local PROP_MODEL = "ericrolph_cannon_car_wash_lowvram"
local PROP_VISUAL_MESH = "ericrolph_cannon_car_wash_lowvram_selector_visual"
local VISUAL_SHAPE = (
  "/vehicles/ericrolph_cannon_car_wash_lowvram/ericrolph_cannon_car_wash_lowvram_runtime_visual.dae"
)
...
local Attract = {
  shape = "/vehicles/ericrolph_cannon_car_wash_lowvram/mini_car.dae",
  cannonShape = "/vehicles/ericrolph_cannon_car_wash_lowvram/cannon.dae",
  carriageShape = "/vehicles/ericrolph_cannon_car_wash_lowvram/carriage.dae",
  intervalSeconds = 120,
  ...
  materialsPath = "art/shapes/ericrolph_cannon_car_wash_lowvram/attract.materials.json",
  requiredMaterials = {
    "ericrolph_cannon_car_wash_lowvram_attract_cannon",
    "ericrolph_cannon_car_wash_lowvram_mini_car_paint",
    "ericrolph_cannon_car_wash_lowvram_mini_wheel",
    "ericrolph_cannon_car_wash_lowvram_ramp_flap",
    "ericrolph_cannon_car_wash_lowvram_carriage_oak",
    "ericrolph_cannon_car_wash_lowvram_attract_iron",
    ...
    "ericrolph_cannon_car_wash_lowvram_glass",
    "ericrolph_cannon_car_wash_lowvram_stainless",
  },
}
...
local Panel = {
  flapShape = "/vehicles/ericrolph_cannon_car_wash_lowvram/ramp_flap.dae",
...
local VISUAL_MATERIALS_PATH = "vehicles/ericrolph_cannon_car_wash_lowvram/main.materials.json"
local REQUIRED_VISUAL_MATERIALS = {
  "ericrolph_cannon_car_wash_lowvram_selector_brush_aqua",
  "ericrolph_cannon_car_wash_lowvram_selector_brush_blue",
  "ericrolph_cannon_car_wash_lowvram_selector_brush_cards",
  "ericrolph_cannon_car_wash_lowvram_selector_concrete",
  "ericrolph_cannon_car_wash_lowvram_selector_corrugated_blue",
  "ericrolph_cannon_car_wash_lowvram_selector_cyan_trim",
  "ericrolph_cannon_car_wash_lowvram_selector_deep_blue",
  "ericrolph_cannon_car_wash_lowvram_selector_exterior_cmu",
  "ericrolph_cannon_car_wash_lowvram_selector_glass",
  "ericrolph_cannon_car_wash_lowvram_selector_hazard_yellow",
  "ericrolph_cannon_car_wash_lowvram_selector_interior_brick",
  "ericrolph_cannon_car_wash_lowvram_selector_led",
  "ericrolph_cannon_car_wash_lowvram_selector_rubber",
  "ericrolph_cannon_car_wash_lowvram_selector_safety_orange",
  "ericrolph_cannon_car_wash_lowvram_selector_screen",
  "ericrolph_cannon_car_wash_lowvram_selector_sign_face",
  "ericrolph_cannon_car_wash_lowvram_selector_control_panel",
  "ericrolph_cannon_car_wash_lowvram_selector_stainless",
  "ericrolph_cannon_car_wash_lowvram_selector_wet_concrete",
}
local UI_CATEGORY = "ericrolph_cannon_car_wash_lowvram_runtime_countdown"
local TRIGGER_CLASS = "BeamNGTrigger"
local VISUAL_CLASS = "TSStatic"
local EFFECT_CLASS = "ParticleEmitterNode"
local LIGHT_SPECS = require("common/ericrolph_cannon_car_wash_lowvram/lighting")
  ...
  for _, objectName in ipairs(names) do
    if type(objectName) == "string" then
      local propId = string.match(
        objectName,
        "^ericrolph_cannon_car_wash_lowvram_runtime_(%d+)_[%w_]+$"
      )
...
local function registerProp(propId)
  ...
  local prefix = string.format("ericrolph_cannon_car_wash_lowvram_runtime_%d", propId)
  local state = {
    propId = propId,
    prefix = prefix,
