...
local GE_EXTENSION_PATH = "ericrolph_cannon_car_wash_lowvram/runtime"
-- BeamNG doubles literal underscores before replacing the path separator.
-- ericrolph_cannon_car_wash_lowvram/runtime ->
-- ericrolph__cannon__car__wash__lowvram_runtime
local GE_EXTENSION_NAME = "ericrolph__cannon__car__wash__lowvram_runtime"
