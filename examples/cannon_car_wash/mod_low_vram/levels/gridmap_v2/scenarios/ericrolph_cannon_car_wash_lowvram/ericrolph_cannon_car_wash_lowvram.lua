...
local LAUNCH_TRIGGER_NAME = "ericrolph_cannon_car_wash_lowvram_launch_trigger"
local WASH_TRIGGER_NAME = "ericrolph_cannon_car_wash_lowvram_wash_activation_trigger"
local REPAIR_TRIGGER_NAME = "ericrolph_cannon_car_wash_lowvram_repair_trigger"
local TRIGGER_CLASS = "BeamNGTrigger"
local VISUAL_NAME = "ericrolph_cannon_car_wash_lowvram_scenario_visual"
local VISUAL_CLASS = "TSStatic"
local EFFECT_CLASS = "ParticleEmitterNode"
-- Low VRAM edition: the wash runs without particle effects.
local EFFECT_SPECS = {}
local UI_CATEGORY = "ericrolph_cannon_car_wash_lowvram_countdown"
...
-- realignment, no dependence on the wash orientation, and no follow-camera
