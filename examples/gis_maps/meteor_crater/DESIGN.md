...
- **Bumps become objects.** A 6 m grey opening lifts every compact bump 0.45 m or
  ...
  takes the bare earth too, but its photograph stays. A bump over 3 m tall on more
...
| Slope mean / p95 / over 30 deg | 10.6 / 36.9 deg / 10.3% |
| Layer split | mc_desert_floor 47%, mc_ejecta_gravel 23%, mc_rim_rubble 8%, mc_talus 8%, mc_limestone_rim_ew 6%, mc_limestone_rim 6%, mc_road_asphalt 1%, mc_road_dirt 1% |
| Roads | 26 decal roads, 9.6 km (service 10, tertiary 1, track 15) |
| Spawns | spawn_north_rim_visitor_center at (74, 646), 1711 m; spawn_crater_floor at (1, 1), 1564 m; spawn_south_rim at (-48, -638), 1728 m |
| Imagery de-lighting | sun az 257 / alt 54 deg (fit r=0.66), Minnaert k 1.40, cast shadow 0.2%, gain p05-p95 0.89-1.48 |
| Surface objects removed | 4351 bumps (linear 51, rock 3490, shrub 767), 0 structures, 49880 m3 lowered |
| Road beds carved | 26 ways, 9.7 km, cut/fill up to 1.2/1.3 m, 154742 bed cells |
| Placed objects | 4745 forest items: 3009 rocks, 1736 shrubs, 0 trees (); 1.2 M triangles if all drawn |
| Distribution | `meteor_crater_ericrolph.zip`, 127 members, 175.4 MB, sha256 `3da30efb1472ef22...`, build serial 5 |
