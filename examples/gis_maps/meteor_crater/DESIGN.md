...
| Surface objects removed | 4815 bumps (linear 53, rock 3515, shrub 1175), 0 structures, 52048 m3 lowered |
| Road beds carved | 26 ways, 9.7 km, cut/fill up to 1.2/1.3 m, 154742 bed cells |
| Placed objects | 6583 forest items: 3050 rocks, 3533 shrubs, 0 trees (); 1.2 M triangles if all drawn |
| Distribution | `meteor_crater_ericrolph.zip`, 127 members, 175.7 MB, sha256 `2adb13629a628c69...`, build serial 8 |
