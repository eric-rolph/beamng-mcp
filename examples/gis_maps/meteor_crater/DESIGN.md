...
| Surface objects removed | 4805 bumps (linear 50, rock 3509, shrub 1152), 0 structures, 52048 m3 lowered |
| Road beds carved | 26 ways, 9.7 km, cut/fill up to 1.2/1.3 m, 154742 bed cells |
| Placed objects | 9170 forest items: 3060 rocks, 6116 shrubs, 0 trees (); 1.3 M triangles if all drawn |
| Distribution | `meteor_crater_ericrolph.zip`, 127 members, 177.2 MB, sha256 `70dc68d40f5441aa...`, build serial 20 |
