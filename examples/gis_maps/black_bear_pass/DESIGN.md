...
| Layer split | bb_scree_slope 27%, bb_tundra 21%, bb_talus 17%, bb_fellfield 12%, bb_forest_floor 11%, bb_cliff_rock_ew 6%, bb_cliff_rock 5%, bb_road_gravel 0%, bb_lake 0% |
| Roads | 13 decal roads, 19.1 km (track 12, unclassified 1) |
| Spawns | spawn_pass_summit at (1611, -1445), 3910 m; spawn_ingram_basin at (1348, 797), 3662 m; spawn_wrecked_section_1 at (376, 1078), 3450 m; spawn_the_steps at (145, 1144), 3389 m; spawn_bridal_veil_base at (-1224, 1896), 2756 m; spawn_switchbacks at (5, 1064), 3340 m |
| Imagery de-lighting | sun az 201 / alt 55 deg (fit r=0.44), Minnaert k 1.35, cast shadow 4.6%, gain p05-p95 0.86-2.56 |
...
| Placed objects | 188898 forest items: 100394 rocks, 0 shrubs, 89053 trees (aspen 5779, aspen_sapling 1884, fir 13819, krummholz 9003, sapling 22040, spruce 21493, willow 15035); 45.9 M triangles if all drawn; trees at the lidar's tops, heights p50 3.6 / p95 20.1 m |
...
| Distribution | `black_bear_pass_ericrolph.zip`, 160 members, 214.8 MB, sha256 `daafff42ec301709...`, build serial 20 |
