...
IMAGERY = {
    ...
    "delight": True,
    # The floor was 52, from a near-solar-noon reading of NAIP's flight window at
    # 40.52 N. The first build fitted the sun at exactly 52 degrees, correlation
    # 0.606 - pinned on the bound, as all four of these maps were, so the bound was
